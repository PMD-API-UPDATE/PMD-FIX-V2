...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "PRABATH-MD_pRXXtavh",
    BOT_NUMBER: process.env.BOT_NUMBER || "94729325202",
    PASSWORD: process.env.PASSWORD || "Ent",
    GITHUB_USERNAME: process.env.GITHUB_USERNAME || "saviya55",
    GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN || "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"
    };
