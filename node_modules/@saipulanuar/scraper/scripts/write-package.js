...
async function writePackageJson () {
  ...
  if (!libExists) {
    console.error('@SaipulAnuar/scraper:', 'Lib folder not found after compiling TypeScript')
    process.exit(1)
  }
  ...
  } else console.warn('@SaipulAnuar/scraper:', 'CJS folder not found')
  ...
  } else console.warn('@SaipulAnuar/scraper:', 'ESM folder not found')
  ...
  if (!typesExists && !libEsmExists && !libCjsExists) {
    console.error('@SaipulAnuar/scraper:', 'No compiled TypeScript files found')
    process.exit(1)
  }
}
